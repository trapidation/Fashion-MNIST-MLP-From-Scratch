...
if __name__ == '__main__':
    ...
    print("-------------------------")
    print(f"训练集图像矩阵形状: {X_train.shape}")  # 应该输出 (50000, 784)
    print(f"训练集标签矩阵形状: {y_train.shape}")  # 应该输出 (50000,)
    print(f"验证集图像矩阵形状: {X_val.shape}")  # 应该输出 (10000, 784)
    print(f"验证集标签矩阵形状: {y_val.shape}")  # 应该输出 (10000,)
    print(f"测试集图像矩阵形状: {X_test.shape}")  # 应该输出 (10000, 784)
    print(f"测试集标签矩阵形状: {y_test.shape}")  # 应该输出 (10000,)
    print("-------------------------")
